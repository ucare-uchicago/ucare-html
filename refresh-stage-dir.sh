...
rsync -Parv --exclude ".git" ./* ruidanli@linux2.cs.uchicago.edu:/stage/ucare/html
ssh -o StrictHostKeyChecking=no -A ruidanli@linux2.cs.uchicago.edu 'cd /stage/ucare/html ; sh change-permission.sh' >/tmp/change-permission.txt
echo ""
